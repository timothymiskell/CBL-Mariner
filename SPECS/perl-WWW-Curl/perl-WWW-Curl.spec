...
Patch2:         WWW-Curl-4.17-Work-around-a-macro-bug-in-curl-7.87.0.patch
...
%changelog
* Tue Mar 14 2023 Nan Liu <liunan@microsoft.com> - 4.17-13
- Adding a patch to fix a macro bug in curl 7.87.0.
